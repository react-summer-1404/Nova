...
import { getReplies } from '../../../../servises/api/coursesDetail/getCommentReply';

const UserComment = ({insertDate, author,disslikeCount,likeCount, pictureAddress,describe,title,CommentId,CourseId } ) => {
    const [showReplies, setShowReplies] = useState(true);
    const {data} = useQuery({
        queryKey : ["replies", CourseId, CommentId],
        queryFn : () => getReplies(CourseId, CommentId)
    });
    ...
    return (
        ...
        <div className ='w-full border-t-1 border-b-1 flex-col border-[#E8E8E8] h-[120px] lg:h-[140px] flex gap-4'>
            ...
            <img src={pictureAddress} className ='lg:w-[12%] lg:h-[58%] w-[15%] h-[40%] rounded-full mt-[17px]'/>
            {showReplies && (
                <>
                    <div className ='flex w-full flex-col items-end mt-[10px] lg:mt-[8px] gap-1 lg:gap-2'>
                    <div className ='w-full flex justify-between'>
