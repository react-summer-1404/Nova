    ...
    <div className =' w-screen h-[300px] flex items-center justify-center '>
      <div className ='w-[80%] h-[250px] bg-[#282568] rounded-[40px] flex justify-center items-center'>
        <div className ='w-1/4 text-white h-[200px] flex justify-center flex-col'>
          <div className ='font-[900] text-[34px] '>45K+</div>
          <div className ='text-[9px] mr-1'>دانشجو های فعال</div>
        </div>
        ...
        <div className ='w-1/4 text-white h-[200px] flex justify-center flex-col'>
          ...
          <div className ='text-[9px] mr-1'>دروس انشکده </div>
        </div>
        <div className ='w-1 rounded-[5px] bg-gradient-to-b from-[#FFFFFF] to-transparent h-[90px]'></div>
        <div className ='w-1/4 text-white h-[200px] flex justify-center flex-col'>
          <div className ='font-[900] text-[34px] '>156K</div>
          <div className ='text-[9px] mr-1'> بهترین اساتید </div>
        </div>
        <div className ='w-1 rounded-[5px] bg-gradient-to-b from-[#FFFFFF] to-transparent h-[90px]'></div>
        <div className ='w-1/4 text-white h-[200px] flex justify-center flex-col'>
          <div className ='font-[900] text-[34px] '>42K</div>
          <div className ='text-[9px] mr-1'> جایزه های بدست امده </div>
        </div>
      </div>
    </div>
  )
