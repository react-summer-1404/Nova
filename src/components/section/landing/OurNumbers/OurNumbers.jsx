  ...
  return (
    <div className=' w-screen h-[300px] flex items-center justify-center '>
      <div className='w-[80%] h-[170px] sm:h-[210px] lg:h-[250px] bg-[#282568] rounded-[40px] flex justify-center items-center'>
        <div className='w-1/4 text-[#fff] h-[200px] flex justify-center flex-col'>
          <div className='font-[900] text-[26px] sm:text-[30px] lg:text-[34px]'>{data?.studentCount}K+</div>
          <div className='text-[8px] sm:text-[11px] lg:text-[13px] mr-1'>{t("ourNumbers.ourNumbersActiveStudents")}</div>
        </div>
        <div className='w-1 rounded-[5px] bg-gradient-to-b from-[#FFFFFF] to-transparent h-[90px]'></div>
        <div  className='w-1/4 h-[200px] flex justify-center flex-col text-[#fff]'>
          <div className='font-[900] text-[26px] sm:text-[30px] lg:text-[34px]'>{data?.courseCount}+</div>
          <div className='text-[8px] sm:text-[11px] lg:text-[13px] mr-1'>{t("ourNumbers.CollegeCourses")}</div>
        </div>
        <div className='w-1 rounded-[5px] bg-gradient-to-b from-[#FFFFFF] to-transparent h-[90px]'></div>
        <div  className='w-1/4 h-[200px] flex justify-center flex-col text-[#fff]'>
          <div className='font-[900] text-[26px] sm:text-[30px] lg:text-[34px]'>{data?.teacherCount}K</div>
          <div className='text-[8px] sm:text-[11px] lg:text-[13px] mr-1'> {t("ourNumbers.BestCoaches")} </div>
        </div>
        <div className='w-1 rounded-[5px] bg-gradient-to-b from-[#FFFFFF] to-transparent h-[90px]'></div>
        <div  className='w-1/4 h-[200px] flex justify-center flex-col text-[#fff]'>
          <div className='font-[900] text-[26px] sm:text-[30px] lg:text-[34px] text-[#fff]'>42K</div>
          <div className='text-[8px] sm:text-[11px] lg:text-[13px] mr-1'>{t("ourNumbers.EarnedAwards")}</div>
        </div>
      </div>
    </div>
  )
