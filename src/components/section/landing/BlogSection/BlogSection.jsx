...
const BlogSection = () => {
  ...
  return (
    <div
      ...
      className="w-screen h-[720px] md:h-[680px] flex justify-center items-center "
    >
      <motion.div
        className="w-[80%] gap-2 flex flex-col items-center md:gap-3"
      ...
      >
        <button className=" h-[25px] rounded-[30px] bg-[#EFEEFE] text-[9px] text-[#5751E1] px-4 md:px-6">
         {t("blogSection.blogSectionTag")}
        </button>
        <p
          style={{ color: "var(--color-navy)" }}
          className="font-[600] text-[28px] md:text-[28px]"
        >
         {t("blogSection.blogSectionTitle")}
        </p>
