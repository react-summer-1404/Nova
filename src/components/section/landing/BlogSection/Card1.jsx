...
const Card1 = () => {
    return (
        <div style={{ backgroundColor: "var(--color-white)" }} className ='w-[25%] h-[375px] rounded-[10px] flex flex-col gap-2 items-center justify-center'>
            <img src="/public/2e915ad34de0b07db8fd026b2dd17808be79f286.jpg" className ='w-[80%] object-cover rounded-[6px]' />
            ...
            <div className ='w-[78%] flex items-center justify-between'>
                ...
                <div style={{ color: "var(--color-white)", backgroundColor: "var(--color-dark-purple)" }} className ='w-[30%] h-[30px] rounded-full font-[500] text-[12px] flex justify-center items-center' >علوم پایه</div>
            </div>
            <h2 style={{ color: "var(--color-text-gray)" }} className ='border-b-[1px] border-[#B5B5C380] h-[60px] px-5 font-[500] text-[12px] '>این خبر برای این است که توسعه خود را بسازید و عنوان محتوای خود میتوانیذ قرار دهید این خبر برای....  </h2>
            <div className ='w-[78%] flex justify-between'>
                ...
                <div style={{ color: "var(--color-text-gray)" }} className ='flex flex-row gap-0.5'>
                    <div className ='font-[500] text-[14px] mt-[-2px]'>20</div>
