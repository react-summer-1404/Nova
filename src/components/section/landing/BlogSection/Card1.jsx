    ...
    return (
        <div style={{ backgroundColor: "var(--color-white)" }} className ='w-[25%] h-[375px] rounded-[10px] flex flex-col gap-2 items-center justify-center'>
            ...
            <div className='w-[78%] flex items-center justify-between'>
                <h2 style={{ color: "var(--color-text-gray)" }} className='font-[400] text-[12px]'>{insertDate} </h2>
            ...
            <h2 style={{ color: "var(--color-text-gray)" }} className='border-b-[1px] border-[#B5B5C380] h-[45px] w-[78%] font-[500] text-[12px] '>{describe}</h2>
