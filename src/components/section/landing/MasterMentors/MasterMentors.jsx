    ...
    <div className ='w-screen h-[320px] flex'>
      ...
      <div className =' w-2/6 flex justify-center items-center '>
        <div className ='md:w-[58%] w-[80%] text-right flex flex-col items-end md:gap-4 gap-1'>
          <button style={{color: "var(--color-dark-purple)" ,backgroundColor: "var(--color-light-purple)"}} className ='md:px-5 p-1 px-2.5 rounded-[30px] text-[10px] '>
            معلم های ماهر
          </button>
          <p style={{color : "var(--color-navy)"}} className =' font-[900] text-[18px] md:text-[30px]'>کلاس برتر ما و مربیان خبره در یک مکان</p>
          <h2 style={{color : "var(--color-text-gray)"}} className ='text-[11px] md:text-[14px]'> 
          ...
          >
            <FaArrowLeft size={13}/>
            <span className ='text-[11px] md:text-[14px]'>همه مربیان را ببینید</span>
