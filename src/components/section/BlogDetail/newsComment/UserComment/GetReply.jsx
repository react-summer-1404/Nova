          ...
          <div className="flex lg:w-4/5 w-2/3 flex-col items-end mt-[10px] lg:mt-[8px] gap-1 lg:gap-2">
            ...
            <div className="w-[85px] h-[25px] flex flex-row gap-0.5">
              <button
                ...
                className="w-[45%] md:w-[50%] h-full rounded-[15px] font-[500] text-[10px] md:text-[12px] flex flex-row items-center gap-0.5 justify-center text-[#5F5F66]"
              >
                {item.likeCount} <BiLike />
              </button>
              <button
                style={{ backgroundColor: "var(--color-soft-gray)" }}
                className="w-[45%] md:w-[50%] h-full rounded-[15px] font-[500] text-[10px] md:text-[12px] flex flex-row items-center gap-0.5 justify-center text-[#5F5F66]"
              >
                {item.disslikeCount} <BiDislike />
              </button>
            </div>
          </div>
        </div>
