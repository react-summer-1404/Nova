...
const Slider = () => {
  ...
  return (
    <div className="bg-gray-500 flex-center md:w-3/4  p-2 rounded-full w-[400px]">
      ...
      <button className=" p-4 rounded-full mr-5" onClick={nextSlide}>next</button>
  
      <div className="overflow-hidden">
        <div className="flex w-fit gap-1 " style={{ transform: `translateX(-${slide * (100 / 6)}%)`} } >
      ...
      <button className="bg-blue-500 p-4 rounded-full ml-5" onClick={prevSlide}>prev</button>
    </div>
